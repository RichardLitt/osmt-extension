...
function clear_page() {
    ...
    document.getElementsByClassName('-cx-PRIVATE-fbLayout__root')[0] = document.getElementsByClassName('-cx-PRIVATE-fbLayout__root')[0].removeChild(document.getElementById('pagelet_bluebar'));
    // Or the rest of the page, to be honest
    document.getElementsByClassName('-cx-PRIVATE-fbLayout__root')[0] = document.getElementsByClassName('-cx-PRIVATE-fbLayout__root')[0].removeChild(document.getElementById('globalContainer'));
    ...
    document.getElementsByClassName('-cx-PRIVATE-fbLayout__root')[0] = document.getElementsByClassName('-cx-PRIVATE-fbLayout__root')[0].removeChild(document.getElementById('pagelet_sidebar'));
...
function add_image() {
    var mydiv = document.getElementsByClassName('-cx-PRIVATE-fbLayout__root');
    var newcontent = document.createElement('div');
    // Edit the src to point to a wallpaper you, you know, like.
    newcontent.innerHTML = '<div style="background-image:url(http://i.imgur.com/yXABw.jpg);height:820px;background-size:contain;"></div>';
